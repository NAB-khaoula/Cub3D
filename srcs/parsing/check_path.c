...
{
	if (*gnrl->map.line == 'E' && *(gnrl->map.line + 1) == 'A'
	&& *(gnrl->map.line + 2) == ' ' && gnrl->map.check_e == 0)
	{
		gnrl->map.check_e = 1;
		gnrl->map.east = (char *)malloc(sizeof(char) *
		ft_strlen(gnrl->map.path));
		gnrl->map.east = ft_strdup(gnrl->map.path);
	}
	else if (gnrl->map.check_e == 1)
		ft_error("Error\nCheck duplicated lines, focus mate!");
	else if (*gnrl->map.line == 'E' && (*(gnrl->map.line + 1) != 'A'
	|| *(gnrl->map.line + 2) != ' '))
...
{
	if (*gnrl->map.line == 'W' && *(gnrl->map.line + 1) == 'E'
	&& *(gnrl->map.line + 2) == ' ' && gnrl->map.check_w == 0)
	{
		gnrl->map.check_w = 1;
		...
		ft_error("Error\nCheck duplicated lines, focus mate!");
	else if (*gnrl->map.line == 'W' && (*(gnrl->map.line + 1) != 'E'
	|| *(gnrl->map.line + 2) != ' '))
		ft_error("Error\n Texture format invalid");
}
...
{
	if (*gnrl->map.line == 'S' && *(gnrl->map.line + 1) == 'O'
	&& *(gnrl->map.line + 2) == ' ' && gnrl->map.check_s == 0)
	{
		gnrl->map.check_s = 1;
		gnrl->map.south = ft_strdup(gnrl->map.path);
	}
	else if (*gnrl->map.line == 'S' && *(gnrl->map.line + 1) == ' '
	&& gnrl->map.check_sp == 0)
	{
		gnrl->map.check_sp = 1;
		...
		ft_error("Error\nCheck duplicated lines, focus mate!");
	else if (*gnrl->map.line == 'S' && (*(gnrl->map.line + 1) != 'O'
	|| *(gnrl->map.line + 2) != ' '))
		ft_error("Error\n Texture format invalid");
}
...
{
	if (*gnrl->map.line == 'N' && *(gnrl->map.line + 1) == 'O'
	&& *(gnrl->map.line + 2) == ' ' && gnrl->map.check_n == 0)
	{
		gnrl->map.check_n = 1;
		...
		ft_error("Error\nCheck duplicated lines, focus mate!");
	else if (*gnrl->map.line == 'N' && (*(gnrl->map.line + 1) != 'O'
	|| *(gnrl->map.line + 2) != ' '))
		ft_error("Error\n Texture format invalid");
}
