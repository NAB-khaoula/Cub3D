...
/*   Updated: 2020/11/12 14:54:24 by knabouss         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    check_west(t_struct    *gnrl)
{
    ...
    {
        gnrl->map.check_w = 1;
        gnrl->map.west = (char *)malloc(sizeof(char) * ft_strlen(gnrl->map.path));
		gnrl->map.west = gnrl->map.path;
    }
...
void    check_south_sprite(t_struct   *gnrl)
{
    ...
    {
        gnrl->map.check_s = 1;
        gnrl->map.south = (char *)malloc(sizeof(char) * ft_strlen(gnrl->map.path));
		gnrl->map.south = gnrl->map.path;
    }
    else if (*gnrl->map.line == 'S' && *(gnrl->map.line + 1) == ' ' && gnrl->map.check_sp == 0)
    {
        gnrl->map.check_sp = 1;
        gnrl->map.sprite = (char *)malloc(sizeof(char) * ft_strlen(gnrl->map.path));
	    gnrl->map.sprite = gnrl->map.path;
    }
...
void    check_north(t_struct   *gnrl)
{
    ...
    {
        gnrl->map.check_n = 1;
        gnrl->map.north = (char *)malloc(sizeof(char) * ft_strlen(gnrl->map.path));
		gnrl->map.north = gnrl->map.path;
    }
